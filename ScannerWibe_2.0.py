...
class TopbarGlowBars(tk.Canvas):
    ...
    beside the SCANNERWIBE 2.0 logo. Always running.
    """
...
class DashboardPanel(tk.Frame):
    ...
    def _build(self):
        ...
        tk.Label(tl, text="SENTINEL", font=("Consolas", 24, "bold"),
    ...
    def _build_how_to_use(self, parent):
        ...
        tk.Label(hdr, text="  HOW TO USE SENTINEL",
    ...
    def _build_why_useful(self, parent):
        ...
        tk.Label(hdr, text="  WHY SENTINEL MATTERS",
...
class ScannerPanel(tk.Frame):
    ...
    def _start(self):
        ...
        self._write_log(f"  │  SENTINEL v6  ·  Target: {tgt}","accent")
...
class AboutPanel(tk.Frame):
    ...
    def _build(self):
        ...
        tk.Label(info,text="SENTINEL v5",font=("Consolas",16,"bold"),fg=C["text"],bg=C["bg2"]).pack(anchor="w")
        ...
        for title,text in [
            ("OVERVIEW",
             "Sentinel v5 is a professional-grade network security scanner.\n"
